...
import { createCSSVariables, formatNumberToTwoDigits, formatStringIfTrue } from "~utils";
...
export const Settings = ({ render, close, exitDelay }: RenderTransitionControls) => {
    ...
    return (
        ...
        >
            ...
            >
                <div className={formatClassName([styles.container__box, styles["container__box--heading"]])}>
                    <h2 className={formatClassName([styles.container__text, styles["container__text--title"]])}>
                        Settings
                    </h2>
                    <button
                        type="button"
                ...
                <div className={formatClassName([styles.container__box, styles["container__box--main"]])}>
                    <fieldset className={formatClassName([styles.container__box, styles["container__box--fieldset"]])}>
                        <legend
                            className={formatClassName([styles.container__text, styles["container__text--subtitle"]])}
                        >
                            General settings
                        </legend>
                        <div className={formatClassName([styles.container__box, styles["container__box--fields"]])}>
                            <SliderInput
                                htmlFor="Sounds"
                                text="Sounds"
                                icon="SpeakerHigh"
                    ...
                    <button
                        ...
                        className={formatClassName([styles.container__button, styles["container__button--reset"]])}
                    >
                        <Icon
                            ...
                            size="sm"
                        />
                        <span className={formatClassName([styles.container__text, styles["container__text--reset"]])}>
                            Restore
                        </span>
                    </button>
                </div>
